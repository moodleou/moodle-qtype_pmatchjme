...
$string['enablejava'] = 'Loading JME editor..... If this message does not get replaced by the JME editor then you have not got a JAVA runtime environment working in your browser.';
...
$string['smiles_carbon_overall'] = 'carbon atoms';
$string['smiles_c'] = 'aromatic carbon atoms';
...
$string['smiles_='] = 'double bonds';
$string['smiles_#'] = 'triple bonds';
$string['smilesequal'] = 'You have the correct number of {$a}.';
$string['smilestoofew'] = 'You have too few {$a}.';
$string['smilestoomany'] = 'You have too many {$a}.';
